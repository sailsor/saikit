...
import (
	...
	repo "code.jshyjdtech.com/godev/hykit/tool/ifacer/example/repo"
)
...
func TestIfacer_GetUniqueImportName(t *testing.T) {
	pkgName := "code.jshyjdtech.com/godev/hykit/redis"
...
func TestIfacer_SetNoConflictImport(t *testing.T) {
	testCases := []struct {
		...
		{"redis", "redis", "code.jshyjdtech.com/godev/hykit/redis", "code.jshyjdtech.com/godev/hykit/redis"},
